# 딕셔너리(dict)
# 리스트, 튜플 -> index 숫자로 데이터 보관
# dict는 숫자 대신 key라는 데이터로 보관
mr_park = {
    "이름": "박철수",
    "나이": 30,
    "성별": "남자",
...
# items(): (key, value) 쌍으로 튜플을 묶여서 리스트에 모아줌
# [(k,v), (k,v).....]
menu_items = menu.items()
menu_items = list(menu_items)
print(menu_items)

# [('김밥', 3000), ('라면', 5000), ('돈까스', 7000), ('떡볶이', 5000)]
...
# (15, 10)좌표가 맛집인지 확인하는 조건문
# 맛집이면 해당 맛집의 이름을 출력
my_location = (15, 10)
if my_location in my_foodie:
    name = (my_foodie[my_location])
    print(name)
