...
# 2. f-string
introduce = f"안녕하세요, 저는 {name}이고, {age}살 입니다."
...
# address = input("동네 입력 >>")
#
# introduce = f"저는 {name}이고, {address}에서 왔습니다."
# print(introduce)
...
print(f"word의 문자갯수: {len_of_word}")
