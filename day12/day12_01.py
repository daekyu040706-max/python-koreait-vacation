...
acc1 = BankAccount("기업001", "홍길동")
acc2 = BankAccount("농협001", "둘리")

acc1.deposit(10000)
acc2.deposit(5000)

# 같은 함수를 호출 하지만, 객체가 가지고 있는 데이터에 따라
# 서로 다르게 동작
acc1.withdraw(7000)
acc2.withdraw(7000)
acc1.check_balance()
acc2.check_balance() # 출금되지 않았음 - 의도된 동작

# 물컵 클래스
# fill(self, amount) - water에 amount만큼 더하는데,
# 최대 사이즈 넘기면x
...
cup1.anything = "아무거나"
print(cup1.anything) # 클래스에 정의되어 있지 않음
print(cup1.water)
print(cup1.size)
...
print(isinstance(cup1, Cup)) # cup1이 Cup 객체?