...
# 1. 문자열.replace("바꾸고 싶은 문자열", "대체될 문자열")
a = "my name is Son" # " " -> "_"
a_replace = a.replace(" ", "_")
a_replace2 = a.replace("Son", "") # 삭제

# 2. 문자열.strip(문자열 패턴)
# 문자열 처음과 끝에서 매칭되는 문자열 패턴을 삭제
a = "  데이터  "
print(a)
a_strip = a.strip() # 문자열 기준 좌우공백 제거
a = "**데이터**"
a_strip2 = a.strip("*") # 문자열 기준 좌우 "*"들 제거
...
# "apple iphone 17 Pro"로 변환시켜 주세요
# strip -> replace -> lower
...
# 문자열 기능들 3 - 검사: 결과로 bool 자료형을 가져옴
